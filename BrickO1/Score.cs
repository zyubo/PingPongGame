...
namespace BrickO1
{
    ...
    public class Score
    {
        ...
        //public void Draw(Graphics g, string player) //draws the Count at the Position
        //{
        //    g.DrawString(player+": "+Count.ToString(), MyFont, Brushes.RoyalBlue, Position.X, Position.Y, new StringFormat());
        //}
